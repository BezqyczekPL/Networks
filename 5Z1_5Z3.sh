...
#uruchom kontener T1 oparty na obrazie alpine z aliasem T1_alias
...
#uruchom kontener T2 na porcie 80 z aliasem T2_80_alias i na podstawie sieci bridge1 na porcie 8000 z aliasem T2_8000_alias na obrazie nginx
...
#uruchom kontener D1 w sieci bridge1 przypisujac IP 10.0.10.254 z aliasem host 1 na obrazie alpine
